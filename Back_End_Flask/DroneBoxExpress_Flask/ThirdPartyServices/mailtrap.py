...
register_mail = mt.Mail(
    sender=mt.Address(email="droneboxexpress@demomailtrap.com", name="DroneBoxExpress Team"),
    to=[],
...
register_staff = mt.Mail(
    sender=mt.Address(email="droneboxexpress@demomailtrap.com", name="DroneBoxExpress HR Team"),
    to=[],
